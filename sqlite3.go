...
func (d *SQLiteDriver) Open(dsn string) (driver.Conn, error) {
	...
	// _pragma_key
	if pragmaKey != "" {
		// PRAGMA statements do not support bind parameters. Quote the passphrase
		// as a SQL string and escape apostrophes before executing it.
		query := fmt.Sprintf("PRAGMA key = '%s';", strings.ReplaceAll(pragmaKey, "'", "''"))
